...
<?php
	...
	echo "Consumer Key:        " . @$keys->consumer->key . "\n";
	echo "Consumer Secret:     " . @$keys->consumer->secret . "\n";
	echo "Access Token:        " . @$keys->access->token . "\n";
	echo "Access Token Secret: " . @$keys->access->secret . "\n";
?>
</pre>

<hr />

<h2>Current URL Configuration</h2>

<pre>
<?php
	echo "Request:             " . @$requestURL . "\n";
	echo "Access:              " . @$accessURL . "\n";
	echo "Authorize:           " . @$authorizeURL . "\n";
	echo "API Root:            " . @$apiURL . "\n";
	echo "\n";
